 ...
 * @author andik
 */
public class Quis_A_3012 {

    public static void main(String[] args) {
        // Membuat objek baru
        Nelayan_21103012 n1 = new Nelayan_21103012();
        Nelayan_21103012 n2 = new Nelayan_21103012();
        Dokter_21103012 d1 = new Dokter_21103012();
        Dokter_21103012 d2 = new Dokter_21103012();

        // BufferedReader berfungsi sebagai inputan dari user
...
//            menampilkan data dari dokter
        ...
        } catch (IOException eox) // berfungsi untuk menangkap kesalahan
        {
